...
units angstrom
    ...
    def _record_component_mse(self, split, component_MSE) -> None:
        ...
        if isinstance(component_MSE, torch.Tensor):
            # A single-component route -- cliff_exch trains against SAPT Exch
            # alone -- reduces to a 0-d tensor, which is not iterable.
            component_MSE = torch.atleast_1d(component_MSE)
