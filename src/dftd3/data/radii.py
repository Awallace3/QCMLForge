...
def COV_D3(
    ...
    """
    Provide covalent radii for elements (index 0 is unused), converted to Bohr.
    
    Radii are taken from Pyykkö and Atsumi (Chem. Eur. J. 15, 2009, 188–197); values for metals have been decreased by 10%.
    
    Returns:
        torch.tensor: 1D tensor of covalent radii in Bohr; element atomic number corresponds to the tensor index (index 0 is a placeholder).
    """
