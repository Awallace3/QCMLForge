...
def R4R2(
    ...
    """
    Return a 1D tensor of r⁴ over r² expectation values indexed by atomic number.
    
    Parameters:
        dtype (torch.dtype | None): Desired data type for the returned tensor. Defaults to None.
        device (torch.device | None): Desired device for the returned tensor. Defaults to None.
    
    Returns:
        torch.Tensor: 1D tensor where element i corresponds to the computed r⁴/r² expectation value for atomic number i.
    """
...
def R4R2_alt(
    ...
    """
    Compute r⁴ over r² expectation values and return them as a 1D tensor.
    
    Parameters
    ----------
    dtype : torch.dtype | None, optional
        Desired data type of the returned tensor. If None, the default torch dtype is used.
    device : torch.device | None, optional
        Desired device for the returned tensor. If None, the default device is used.
    
    Returns
    -------
    torch.Tensor
        1D tensor containing the computed r⁴/r² expectation values for indices 0..N-1.
    """
